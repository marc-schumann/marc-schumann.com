...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/assetic/config'), false)));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_4120004fcd23b050cefebdf429eb9610');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_4120004fcd23b050cefebdf429eb9610');
        ...
        $d->setProxyDir('D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/XAMPP/htdocs/dev-ms.com/Symfony/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/XAMPP/htdocs/dev-ms.com/Symfony/app/../web', false);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod',
            ...
            'session.save_path' => 'D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/sessions',
            ...
            'router.resource' => 'D:/XAMPP/htdocs/dev-ms.com/Symfony/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => 'D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/jms_aop',
            ...
            'security.extra.cache_dir' => 'D:/XAMPP/htdocs/dev-ms.com/Symfony/app/cache/prod/jms_security',
